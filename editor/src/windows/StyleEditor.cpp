...
void StyleEditor::draw() {
	if (visible)
	{
        ...
        ImGui::Begin("Color Settings", &visible);
        ImGui::ShowStyleSelector("Color Selector");
        if (ImGui::Button("Save my current theme"))
        {
            if (!SaveStyle("./editor.style", ImGui::GetStyle()))
            {
                fprintf(stderr, "Warning: \"./editor.style\" cannot be saved.\n");
            }
            else
            {
                style_idx = ImGuiStyle_Custom;
                editor->showStyleSaveSuccessPopup();
            }
        }
        ImGui::SameLine();
        if (ImGui::Button("Load my current theme"))
        {
            if (!LoadStyle("./editor.style", ImGui::GetStyle()))
            {
                fprintf(stderr, "Warning: \"./editor.style\" not found.\n");
            } else
            {
                style_idx = ImGuiStyle_Custom;
                editor->showStyleLoadSuccessPopup();
            }
        }
        if (ImGui::TreeNodeEx("Advanced", base_flags, "Advanced"))
        {
...
static bool ImGui::ShowStyleSelector(const char* label)
{
    if (ImGui::Combo(label, &style_idx, DefaultStyleNames, IM_ARRAYSIZE(DefaultStyleNames)))
    {
        ResetStyle(style_idx, ImGui::GetStyle());
        return true;
    }
    return false;
}

const char** GetDefaultStyleNames() { return DefaultStyleNames; }
...
bool LoadStyle(const char* filename, ImGuiStyle& style)
{
    ...
    for (const char* line_start = f_data; line_start < buf_end; )
    {
        ...
        } else if (name[0] != '\0')
        {
            ...
            {
                if (strcmp(name, "Alpha") == 0) { npf = 1;pf[0] = &style.Alpha; } else if (strcmp(name, "WindowPadding") == 0) { npf = 2;pf[0] = &style.WindowPadding.x;pf[1] = &style.WindowPadding.y; } else if (strcmp(name, "WindowRounding") == 0) { npf = 1;pf[0] = &style.WindowRounding; } else if (strcmp(name, "WindowBorderSize") == 0) { npf = 1;pf[0] = &style.WindowBorderSize; } else if (strcmp(name, "WindowMinSize") == 0) { npf = 2;pf[0] = &style.WindowMinSize.x;pf[1] = &style.WindowMinSize.y; } else if (strcmp(name, "WindowMenuButtonPosition") == 0) { npi = 1;pi[0] = &style.WindowMenuButtonPosition; } else if (strcmp(name, "ChildRounding") == 0 ||
                    strcmp(name, "ChildWindowRounding") == 0) {
                    npf = 1;pf[0] = &style.ChildRounding;
                } else if (strcmp(name, "ChildBorderSize") == 0) { npf = 1;pf[0] = &style.ChildBorderSize; } else if (strcmp(name, "PopupRounding") == 0) { npf = 1;pf[0] = &style.PopupRounding; } else if (strcmp(name, "PopupBorderSize") == 0) { npf = 1;pf[0] = &style.PopupBorderSize; } else if (strcmp(name, "FramePadding") == 0) { npf = 2;pf[0] = &style.FramePadding.x;pf[1] = &style.FramePadding.y; } else if (strcmp(name, "FrameRounding") == 0) { npf = 1;pf[0] = &style.FrameRounding; } else if (strcmp(name, "FrameBorderSize") == 0) { npf = 1;pf[0] = &style.FrameBorderSize; } else if (strcmp(name, "ItemSpacing") == 0) { npf = 2;pf[0] = &style.ItemSpacing.x;pf[1] = &style.ItemSpacing.y; } else if (strcmp(name, "ItemInnerSpacing") == 0) { npf = 2;pf[0] = &style.ItemInnerSpacing.x;pf[1] = &style.ItemInnerSpacing.y; } else if (strcmp(name, "IndentSpacing") == 0) { npf = 1;pf[0] = &style.IndentSpacing; } else if (strcmp(name, "TouchExtraPadding") == 0) { npf = 2;pf[0] = &style.TouchExtraPadding.x;pf[1] = &style.TouchExtraPadding.y; } else if (strcmp(name, "WindowFillAlphaDefault") == 0) { npf = 1;pf[0] = &WindowFillAlphaDefault; } else if (strcmp(name, "ScrollbarRounding") == 0) { npf = 1;pf[0] = &style.ScrollbarRounding; } else if (strcmp(name, "WindowTitleAlign") == 0) { npf = 2;pf[0] = &style.WindowTitleAlign.x;pf[1] = &style.WindowTitleAlign.y; } else if (strcmp(name, "ButtonTextAlign") == 0) { npf = 2;pf[0] = &style.ButtonTextAlign.x;pf[1] = &style.ButtonTextAlign.y; } else if (strcmp(name, "ColumnsMinSpacing") == 0) { npf = 1;pf[0] = &style.ColumnsMinSpacing; } else if (strcmp(name, "ScrollbarSize") == 0) { npf = 1;pf[0] = &style.ScrollbarSize; } else if (strcmp(name, "GrabMinSize") == 0) { npf = 1;pf[0] = &style.GrabMinSize; } else if (strcmp(name, "GrabRounding") == 0) { npf = 1;pf[0] = &style.GrabRounding; } else if (strcmp(name, "DisplayWindowPadding") == 0) { npf = 2;pf[0] = &style.DisplayWindowPadding.x;pf[1] = &style.DisplayWindowPadding.y; } else if (strcmp(name, "DisplaySafeAreaPadding") == 0) { npf = 2;pf[0] = &style.DisplaySafeAreaPadding.x;pf[1] = &style.DisplaySafeAreaPadding.y; } else if (strcmp(name, "AntiAliasedLines") == 0) { npb = 1;pb[0] = &style.AntiAliasedLines; } else if (strcmp(name, "AntiAliasedLinesUseTex") == 0) { npb = 1;pb[0] = &style.AntiAliasedLinesUseTex; } else if (strcmp(name, "AntiAliasedFill") == 0 || strcmp(name, "AntiAliasedShapes") == 0) { npb = 1;pb[0] = &style.AntiAliasedFill; } else if (strcmp(name, "CurveTessellationTol") == 0) { npf = 1;pf[0] = &style.CurveTessellationTol; }
                else if (strcmp(name, "CircleTessellationMaxError") == 0) { npf = 1;pf[0] = &style.CircleTessellationMaxError; } else if (strcmp(name, "CircleSegmentMaxError") == 0) { npf = 1;pf[0] = &CircleSegmentMaxError; } else if (strcmp(name, "TabRounding") == 0) { npf = 1;pf[0] = &style.TabRounding; } else if (strcmp(name, "TabBorderSize") == 0) { npf = 1;pf[0] = &style.TabBorderSize; } else if (strcmp(name, "TabMinWidthForUnselectedCloseButton") == 0 ||
...
bool ResetStyle(int styleEnum, ImGuiStyle& style) {
    ...
    case ImGuiStyle_Gray:
    {
        ...
        style.Colors[ImGuiCol_TitleBg] = ConvertTitleBgColFromPrevVersion(style.Colors[ImGuiCol_WindowBg], ImVec4(0.26f, 0.27f, 0.74f, 1.00f));
        style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.28f, 0.28f, 0.76f, 0.16f);
        style.Colors[ImGuiCol_TitleBgActive] = ConvertTitleBgColFromPrevVersion(style.Colors[ImGuiCol_WindowBg], ImVec4(0.50f, 0.50f, 1.00f, 0.55f));
